    ...
    <>
      <div className="flex w-full justify-center bg-black py-[100px]">
        <div className="flex w-full max-w-[1200px] flex-col items-center gap-16">
          <div className="flex w-[980px] flex-1 flex-col items-center gap-5">
            <SectionTitle title="JOIN COMMUNITY" />
            <h3 className="bg-[linear-gradient(135deg,_rgba(255,255,255,1)_0%,_rgba(255,255,255,0.5)_100%)] bg-clip-text text-center text-[56px] font-thin leading-[1.2em] tracking-[-0.03rem] text-transparent">
              Be the first to hear about the latest and greatest updates,
              features, and all the exciting happenings within the Core
              Blockchain ecosystem.
            </h3>
            <BlurTextReveal
              className="w-[680px] text-center text-lg text-white/[66%]"
